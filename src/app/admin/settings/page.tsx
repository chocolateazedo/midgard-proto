  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-zinc-400 mt-1">Gerencie todas as configurações globais do BotFlow</p>
      </div>
      ...
      <Tabs defaultValue="geral" className="space-y-4">
        ...
        <TabsContent value="geral">
          <Card className="bg-zinc-900 border-zinc-800">
            <CardHeader>
              <CardTitle className="text-zinc-100">Configurações Gerais</CardTitle>
            ...
            <CardContent>
              <form onSubmit={handleSaveGeral} className="space-y-5 max-w-lg">
                <div className="space-y-2">
                  <Label htmlFor="platform-name" className="text-zinc-300">
                    Nome da Plataforma
                  </Label>
                  <Input
                    id="platform-name"
                ...
                <div className="space-y-2">
                  <Label htmlFor="platform-url" className="text-zinc-300">
                ...
                <div className="space-y-2">
                  <Label htmlFor="platform-fee" className="text-zinc-300">
        ...
        <TabsContent value="storage">
          <Card className="bg-zinc-900 border-zinc-800">
            <CardHeader>
              <CardTitle className="text-zinc-100">Storage (S3 / Wasabi)</CardTitle>
              <CardDescription className="text-zinc-400">
            ...
            <CardContent>
              <form onSubmit={handleSaveStorage} className="space-y-5 max-w-lg">
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <SelectContent className="bg-zinc-800 border-zinc-700">
                      <SelectItem value="s3" className="text-zinc-100">AWS S3</SelectItem>
                      <SelectItem value="wasabi" className="text-zinc-100">Wasabi</SelectItem>
                    </SelectContent>
                  </Select>
                </div>

                <div className="space-y-2">
                  <Label htmlFor="storage-bucket" className="text-zinc-300">Bucket Name</Label>
                  <Input
                    id="storage-bucket"
                    value={storageBucket}
                ...
                <div className="space-y-2">
                  <Label htmlFor="storage-region" className="text-zinc-300">Region</Label>
                  <Input
                    id="storage-region"
                    value={storageRegion}
                ...
                {storageProvider === "wasabi" && (
                  <div className="space-y-2">
                    <Label htmlFor="storage-endpoint" className="text-zinc-300">
                      Endpoint URL (Wasabi)
                    </Label>
                    <Input
                      id="storage-endpoint"
                ...
                <div className="space-y-2">
                  <Label htmlFor="storage-key-id" className="text-zinc-300">Access Key ID</Label>
                  <Input
                    id="storage-key-id"
                ...
                <div className="space-y-2">
                  <Label htmlFor="storage-secret" className="text-zinc-300">Secret Access Key</Label>
                ...
                <div className="space-y-2">
                  <Label htmlFor="storage-public-url" className="text-zinc-300">
                    URL Pública Base
                  </Label>
                  <Input
        ...
        <TabsContent value="telegram">
          <Card className="bg-zinc-900 border-zinc-800">
            <CardHeader>
              <CardTitle className="text-zinc-100">Telegram</CardTitle>
              <CardDescription className="text-zinc-400">
            ...
            <CardContent>
              <form onSubmit={handleSaveTelegram} className="space-y-5 max-w-lg">
                <div className="space-y-2">
                  <Label htmlFor="welcome-msg" className="text-zinc-300">
                ...
                <div className="space-y-2">
                  <Label htmlFor="webhook-base-url" className="text-zinc-300">
        ...
        <TabsContent value="pagamentos">
          <Card className="bg-zinc-900 border-zinc-800">
            <CardHeader>
              <CardTitle className="text-zinc-100">Pagamentos (Pix)</CardTitle>
              <CardDescription className="text-zinc-400">
            ...
            <CardContent>
              <form onSubmit={handleSavePix} className="space-y-5 max-w-lg">
                <div className="space-y-2">
                  <Label className="text-zinc-300">Provedor PSP</Label>
                  <Select
                    value={pixProvider}
                    onValueChange={(v) =>
                  ...
                  >
                    ...
                    <SelectContent className="bg-zinc-800 border-zinc-700">
                      <SelectItem value="efipay" className="text-zinc-100">EFÍ Pay</SelectItem>
                      <SelectItem value="mercadopago" className="text-zinc-100">Mercado Pago</SelectItem>
                      <SelectItem value="asaas" className="text-zinc-100">Asaas</SelectItem>
                    </SelectContent>
                  </Select>
                </div>

                <div className="space-y-2">
                  <Label htmlFor="pix-token" className="text-zinc-300">Access Token</Label>
                  <div className="relative">
                    <Input
                      id="pix-token"
                ...
                <div className="space-y-2">
                  <Label htmlFor="pix-webhook-secret" className="text-zinc-300">
                    Webhook Secret
                  </Label>
                  <div className="relative">
                    <Input
